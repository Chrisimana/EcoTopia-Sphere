    ...
    <header class="bg-background text-white py-16">
      <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto text-center">
          <h1 class="text-4xl md:text-5xl font-bold mb-6">Tampung Air Hujan: Solusi Alami Menghadapi Krisis Air Bersih</h1>
          <p class="text-xl text-ghost-white">Tampung air hujan untuk siram tanaman dan keperluan lain</p>
        </div>
      </div>
    </header>
      ...
      <article class="max-w-6xl mx-auto">
        ...
        <div class="bg-secondary p-8 rounded-lg mt-16">
          ...
          <p class="text-background text-lg leading-relaxed text-justify">
            Penampungan air hujan bukan hanya langkah praktis untuk menghemat air, tetapi juga bentuk adaptasi cerdas terhadap perubahan iklim. Dengan teknologi sederhana dan kesadaran kolektif, masyarakat dapat memanfaatkan sumber daya alam yang melimpah ini tanpa merusak keseimbangan lingkungan. Setiap rumah yang menampung air hujan berarti turut berkontribusi dalam mengurangi risiko kekeringan, menekan banjir, serta menjaga ketersediaan air tanah untuk generasi mendatang. Air hujan adalah anugerah dan menampungnya dengan bijak adalah wujud syukur yang nyata terhadap alam.
          </p>
        </div>
      </article>
    </main>

      ...
      <article class="max-w-6xl mx-auto">
        ...
        <div class="bg-secondary p-8 rounded-lg mt-16">
          ...
          <p class="text-background text-lg leading-relaxed text-justify">
            Penghematan energi listrik bukan sekadar upaya menurunkan tagihan rumah tangga, tetapi merupakan kontribusi nyata terhadap mitigasi perubahan iklim dan konservasi sumber daya alam. Melalui penerapan strategi efisiensi yang berbasis ilmu pengetahuan mulai dari pemilihan teknologi hingga perubahan perilaku setiap individu dapat menjadi bagian dari solusi menuju masa depan yang lebih hijau dan berkelanjutan. Langkah sederhana seperti mengganti lampu, mematikan perangkat yang tidak digunakan, dan memanfaatkan cahaya alami dapat membawa dampak besar bagi keberlanjutan energi global.
          </p>
        </div>
      </article>
    </main>

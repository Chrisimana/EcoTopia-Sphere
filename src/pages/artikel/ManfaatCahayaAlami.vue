    ...
    <header class="bg-background text-white py-16">
      <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto text-center">
          <h1 class="text-4xl md:text-5xl font-bold mb-6">Manfaat Cahaya Alami: Optimalisasi Desain Bangunan untuk Efisiensi Energi dan Kesehatan</h1>
          <p class="text-xl text-ghost-white">Buka jendela di siang hari untuk hemat listrik dan segarkan udara</p>
        </div>
      </div>
    </header>

    ...
    <header class="bg-background text-white py-16">
      <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto text-center">
          <h1 class="text-4xl md:text-5xl font-bold mb-6">Carpooling: Kolaborasi Mobilitas untuk Efisiensi Energi dan Lingkungan Bersih</h1>
          <p class="text-xl text-ghost-white">Berbagi kendaraan untuk hemat biaya dan kurangi emisi</p>
        </div>
      </div>
    </header>
